...
open class ActionPickerView: UIView {
    ...
    public override init(frame: CGRect) {
        ...
        actionButton.activate(constraints: [
            equalDimension(\.widthAnchor, to: 80.0)
        ])

        pickerButton.setImage(UIImage(named: "img_chevron_down", in: .module, compatibleWith: nil), for: .normal)
    }
