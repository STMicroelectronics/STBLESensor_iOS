...
class NewFlowViewController: TableNodeNoViewController<NewFlowDelegate> {
    ...
    override func viewDidLoad() {
        ...
        Buttonlayout.textColorWithIamge(color: ColorLayout.systemWhite.light, image: ImageLayout.Common.save?.withTintColor(ColorLayout.systemWhite.light, renderingMode: .alwaysTemplate)).apply(to: saveButton, text: "  SAVE APP  ")
        ...
        saveButton.on(.touchUpInside) { [weak self] _ in
            self?.presenter.saveAppButtonTapped()
        }
