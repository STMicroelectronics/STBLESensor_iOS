//
//  NavigationControlFeature.swift
//
...
public class NavigationControlFeature: BaseFeature<NavigationControlData> {
    
    
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        
        let parsedData = NavigationControlData(with: data, offset: offset)
