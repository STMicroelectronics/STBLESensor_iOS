//
//  FlowConditionalInputViewController.swift
//  
...
final class FlowConditionalInputViewController: TableNodeNoViewController<FlowConditionalInputDelegate> {
    ...
    override func viewDidLoad() {
        ...
        Buttonlayout.textColorWithIamge(color: ColorLayout.systemWhite.light, image: ImageLayout.Common.done?.withTintColor(ColorLayout.systemWhite.light, renderingMode: .alwaysTemplate)).apply(to: doneButton, text: "SET INPUT")
